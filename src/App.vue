...
export default {
  ...
  methods: {
    ...
    async handleSuccess(res, file, fileList) {
      this.uploadData.fileId = res.data.id
      this.uploadData.fileName = res.data.fileName
      this.uploadData.fileSize = res.data.length
      this.uploadData.uploadTime = res.data.lastUpdatedTime
      this.uploadData.url = res.data.previewUrl
      this.uploadData.fileMd5 = file.hash
    },
